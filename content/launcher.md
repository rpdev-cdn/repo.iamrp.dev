---
title: "RPDev Launcher Module Registry"
...
## 🧩 Hosted Modules & Schemas

1. **Module Catalog**: Complete metadata registry for 9 official feed cards (Threat Intel, Weather, Live System Telemetry, GitHub Fleet Activity).
2. **Schema Engine**: Strict JSON schema definitions validating card layout models, action intents, and AIDL IPC payloads.
3. **Binary Releases**: Pre-compiled `.apk` packages and signed release checksums.
